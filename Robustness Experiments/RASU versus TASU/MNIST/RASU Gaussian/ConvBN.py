...
class ConvBN(nn.Module):
    ...
    def flip_sign(self, tensor, percentage):
        """
        ...
        # Flatten view (no memory copy)
        flat = tensor.view(-1)
    
        # Randomly select indices to flip
        indices = torch.randint(0, numel, (num_to_flip,), device=tensor.device)
    ...
    def init_hdc(self, ratio, seed, flip_perc=None):
        ...
        # if flip_perc is not None and flip_perc > 0.0:
            # self.flip_sign_(self.alphag1, flip_perc)
