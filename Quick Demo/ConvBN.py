...
class ConvBN(nn.Module):
    '''
    This class constructs a block layer for 2d convolution and batch norm.     
    '''
    def __init__(self, 
                 in_channels, 
                 out_channels, 
        ...
        self.bias_trick_par = nn.Parameter(torch.tensor(0.001))
    ...
    def init_hdc(self, ratio, seed):
        ...
        torch.manual_seed(seed)
        self.g = torch.sign(torch.randn(self.nHDC, *w_bn.shape[1:], device=w_bn.device, dtype=w_bn.dtype))
